...
export const selectContentVariants = cva(
  'z-[9999] max-h-96 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border bg-white text-popover-foreground shadow-lg animate-in fade-in-0 zoom-in-95',
);
